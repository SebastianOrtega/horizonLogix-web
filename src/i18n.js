...
export const I18N = {
  es: {
    ...
    form: {
      ...
      errSubmit: "No pudimos enviar tu solicitud. Intenta de nuevo en unos momentos.",
      errCaptcha: "No pudimos validar el captcha. Recarga la página e intenta de nuevo.",
      close: "Cerrar",
    },
    footer: {
  ...
  en: {
    ...
    form: {
      ...
      errReq: "Required.",
      errSubmit: "We couldn't submit your request. Please try again in a moment.",
      errCaptcha: "Captcha validation failed. Reload the page and try again.",
      close: "Close",
    },
    footer: {
